...
void getIPLocation()
{
  ...
  printSeparator();
  Serial.println("  [GEO] Location Info");
  Serial.println("  [GEO] IP Address  : " + geo.ip);
  Serial.println("  [GEO] Latitude    : " + geo.lat);
  Serial.println("  [GEO] Longitude   : " + geo.lon);
  Serial.println("  [GEO] Google Maps : " + geo.mapsLink);
  printSeparator();
...
void getWeather()
{
  ...
  float temp = doc["main"]["temp"];
  printSeparator();
  Serial.printf("  [OWM] Temperature : %.1f °C\n", temp);
  printSeparator();
  Blynk.virtualWrite(V3, temp);
}
...
void setup()
{
  Serial.begin(115200);
  Serial.println("\n==================================================");
  Serial.println("       ESP32 Blynk API Demo – Starting...");
  Serial.println("==================================================");
