...
>>>>>>> f507e39881f13339e490ff7b92d3ddf3a35151a8
5. ...
*/
...
// ===================== TELEGRAM =====================
#define BOT_TOKEN "8513235724:AAGEd2ctrqQeA42Rm-AeNh7olacRghkRu7M"
#define ADMIN_CHAT_ID  "-5275641584"
...
void updateOLED() {
  ...
  display.println("ESP8266 IoT Team 04");
...
void handleNewMessages(int numNewMessages) {
  ...
  for (int i = 0; i < numNewMessages; i++) {
    ...
    if (text == "/start" || text == "/start@iot_team04_bot") {
      sendTelegramTo(chat_id, getCommandHelpText(from_name));
    }
    else if (text == "/led_on" || text == "/led_on@iot_team04_bot") {
      setRelay(true);
      sendTelegramTo(chat_id, "Den da BAT\n" + String(TEAM_NAME));
    }
    else if (text == "/led_off" || text == "/led_off@iot_team04_bot") {
      setRelay(false);
      sendTelegramTo(chat_id, "Den da TAT\n" + String(TEAM_NAME));
    }
    else if (text == "/led_status" || text == "/led_status@iot_team04_bot") {
    ...
    else if (text == "/get_weather" || text == "/get_weather@iot_team04_bot") {
      String weather;
    ...
    else if (text == "/get_gas" || text == "/get_gas@iot_team04_bot") {
      String gasMsg;
      gasMsg += "KHI GAS\n";
      gasMsg += "----------------------\n";
    ...
    else if (text == "/get_all" || text == "/get_all@iot_team04_bot") {
      sendTelegramTo(chat_id, getFormattedSensorData());
    }
    else if (text == "/uptime" || text == "/uptime@iot_team04_bot") {
      String uptime;
