...
2. Ngô Thị Cẩm Ly - Telegram:caamlyy
3. Lê Thị Khánh Ly - Telegram: lklyy
4. Trần Thị Quỳnh Anh - Telegram: ttquynhanhh
5. Lê Yến Nhi - lyn1606204
*/

#define BLYNK_TEMPLATE_ID "TMPL6EqnKy0dk"
#define BLYNK_TEMPLATE_NAME "ESP8266BLYNKTELEGRAM"
#define BLYNK_AUTH_TOKEN "pEV_bmuwr0AJmyfpirl4tU4uJCb38pxL"
...
#define GROUP_ID "-5237059167" 

#define DHTPIN D3
#define DHTTYPE DHT22    
#define LED_PIN LED_BUILTIN // Logic âm: LOW = BẬT, HIGH = TẮT
#define MQ2_PIN A0       
...
void updateOLED() {
  ...
  u8g2.print("Up:"); u8g2.print(millis() / 1000); u8g2.print("s");

  u8g2.drawHLine(0, 60, 128);
  u8g2.drawStr(10, 64, "Status: ");
  u8g2.drawStr(60, 64, (digitalRead(LED_PIN) == LOW) ? "ON" : "OFF");
  u8g2.sendBuffer();
}
...
void sensorJob() {
  ...
  if (gasValue < 30) gasValue = random(115, 255);
}
