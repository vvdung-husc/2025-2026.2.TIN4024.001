...
// --- THÔNG SỐ BLYNK CỦA BẠN ĐÃ ĐƯỢC THAY THẾ ---
#define BLYNK_TEMPLATE_ID   "TMPL6gcYNclky"
#define BLYNK_TEMPLATE_NAME "ESP32 API"
#define BLYNK_AUTH_TOKEN    "39NixeuaaAtsLihx7zi-IQrBL-sq_wHb" 
...
// --- KEY OPENWEATHERMAP CỦA BẠN ĐÃ ĐƯỢC THAY THẾ ---
#define OPENWEATHERMAP_KEY "2725afdcca7fe619e352ab82ecee3145"
...
void updateTemp(){
  ...
  if (!IsReady(lastTime, 100000)) return; // Kiểm tra sau mỗi 100 giây
  if(WiFi.status() != WL_CONNECTED){
...
void uptimeBlynk(){
  ...
  if (!IsReady(lastTime, 1000)) return; // Kiểm tra sau mỗi 1 giây
