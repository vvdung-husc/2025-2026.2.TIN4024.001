...
#define PIN_LDR          13   // cảm biến ánh sáng

TM1637Display display(CLK, DIO);
int valueButtonDisplay = LOW;

/* ================= LDR ================= */
#define LDR_THRESHOLD 1500   // chỉnh theo giá trị bạn đo được
bool isNight = false;
...
void loop()
{
  ...
  if (isNight)
  {
    ProcessNightMode();        // ban đêm: chỉ đèn vàng
  }
  else
  {
    ProcessLEDTrafficWaitTime(); // ban ngày: đủ 3 đèn
  }
}
