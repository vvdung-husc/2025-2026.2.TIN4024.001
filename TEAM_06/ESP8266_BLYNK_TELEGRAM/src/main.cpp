...
const char* BLYNK_AUTH    = "5Fm1PX1fbEFIhICnvcuaUzkDGnl0iai5";
#define BOT_TOKEN "8425397338:AAGVueSsBC0ja8T2zSIwtBaJhgITeoyo6Y0"
#define ADMIN_CHAT_ID  "7406381600"   

const String TEAM_NAME    = "Team 06";
...
void handleTelegram() {
  ...
  for (int i = 0; i < numNew; i++) {
   ...
   String ALLOWED_CHAT = ""; // cho phép tất cả
